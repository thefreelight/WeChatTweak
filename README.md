...
当前支持微信 macOS `4.1.12.53`（构建号 `269365`）的防撤回；该版本的多开补丁因稳定性问题暂时禁用。`4.1.11.80`（构建号 `269136`）支持防撤回与多开。这两个版本目前仅支持 `x86_64`，Apple Silicon Mac 需使用 Rosetta 运行微信；原生 `arm64` 补丁尚未开放。
